...
(6, 1, 'Nmd_R1', 'Core Black / Core Black / Gold Metallic', '22-25', 1, 'Cuando recibes un mensaje de texto con una invitación para salir a la calle no necesitas mucho convencimiento. Ni siquiera tienes que conocer los detalles. Sin importar el lugar o la actividad, siempre te anotas y estos tenis adidas NMD_R1 te acompañan a cada paso del camino con sus detalles metalizados para que nunca pases desapercibido.', 2999, 'T5.jpg', 0, '2022-04-07'),
...
(13, 2, 'Cruise Rider Silk Road', 'Green-Aquamarine', '22-26-5', 1, 'Inspirados en la belleza de los famosos Silk Road, estos tenis incluyen combinaciones de colores que crean un look muy original. La entresuela IMEVA te brinda liviandad y comodidad para que tus pies sean los más felices', 1999, 'T7.jpg', 0, '2022-04-07'),
...
(26, 4, 'Royal Complete Clean 2.0', 'White', '25-28', 0, 'Camina suave y cómodamente con los Tenis Reebok Royal Complete Clean 2.0 Unisex. Te ofrecen un gran estilo a tus pies y esto los hacen sencillos de poder combinar con muchas cosas que gustes ponerte.', 999, 'T21.jpg', 0, '2022-04-07'),
(27, 4, 'Freestyle Motion Lo', 'Arena', '22.5-25.5', 1, 'Este calzado deportivo es ideal para que luzcas en cada entrenamiento, su ligereza te brinda un rendimiento óptimo para seguir con gran parte de tus ejercicios, en la parte superior cuenta con un tejido de malla para una mayor transpirabilidad para el pie y con la flexibilidad para los movimientos de más agilidad.', 1899, 'T22.jpg', 0, '2022-04-07'),
(28, 3, 'Cosmic Unity Amalgam', 'Black', '25-28', 0, 'Este calzado en color negro y verde tiene una construcción de un mínimo de 20% materiales reciclados. Mantienen así la transpiribilidad y también los hacen más ligeros. Cuentan con unas agujetas y lengüeta, que son sencillas de ajustar.', 3399, 'T23.jpg', 0, '2022-04-07'),
(29, 3, ' Air Zoom Terra Kiger 7', 'Green', '25-30', 0, 'Los Tenis Nike Air Zoom Terra Kiger 7 son para trail running especiales para terrenos rocosos, el diseño es ligero y veloz para mantener un ritmo alto en tus entrenamientos. La parte superior está hecha de material de malla y dan una ventilación adicional, el sistema Dynamic Fit se ajusta cómodamente alrededor del mediopié.', 2699, 'T24.jpg', 0, '2022-04-07'),
(30, 5, 'Classic Slip-On Bandana Yellow', 'Yellow', '25-28', 0, 'Siente la comodidad y suavidad que VANS te ofrece en cada paso con los Tenis Vans Classic Slip-On Bandana Yellow para hombres. Estupendos y perfectos para cualquier día de la semana que gustes ponértelos.', 1999, 'T25.jpg', 0, '2022-04-07'),
(31, 5, 'Old Skool Shale Green', 'Green', '25.5-28', 0, 'Los Tenis Vans Old Skool Shale Green para hombres son perfectos para cualquier día de la semana. Son estupendos para tu porte casual regular y podrás combinarlos con cualquier cosa que gustes ponerte.', 1199, 'T26.jpg', 0, '2022-04-07'),
...
(34, 5, 'Ultrarange Rapidweld', 'Pick', '22.5-26', 1, 'Los tenis Vans Ultrarange Rapidweld para mujeres mezclan el estilo deportivo y moderno para usar en tu día, además de usar en cualquier ocasión, ya que aportan un diseño versátil y muy cómodo.', 1799, 'T29.jpg', 0, '2022-04-07'),
(35, 5, 'Checkerboard Classic Slip.On', 'Multicolor', '24.5', 1, 'Los Tenis Vans Checkerboard Classic Slip.On unisex son un calzado clásico y de los más famosos de Vans. Sin duda, deben formar parte de tu colección y usar en tus looks diarios.', 999, 'T30.jpg', 0, '2022-04-07');
